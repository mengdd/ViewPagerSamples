...
import com.example.android.transformers.DepthPageTransformer;
import com.example.android.transformers.ZoomOutPageTransformer;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			...
			case R.id.action_previous:
				// Go to the previous step in the wizard. If there is no
				// previous step,
